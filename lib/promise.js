...
// ==========================================================================
/*globals Promise create RESOLVED PENDING CANCELLED BUSY BLOCKED utils */
...
Promise.prototype = {
  ...
  */
  resolve: function(val) {
    ...
    if (LOG_PROMISES) console.log(this.id + ".resolve() dep=" + this.outstandingDependencies + ' status=' + this.status);
