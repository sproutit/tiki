...
var pconsole = tiki.platform('console');
if (pconsole) pconsole = pconsole.console; // get the platform console
var COLON = ': ', NEWLINE = "\n", TILDA = ' ~ ';
...
/**
  ...
  @since Tiki 1.0
*/
Logger = utils.extend(/** @scope Logger.prototype */ {

  init: function(id, console) {
    this.id = id ;
