...
// ==========================================================================
/*globals T_ERROR T_OBJECT T_NULL T_CLASS T_HASH T_FUNCTION T_NUMBER T_BOOL T_ARRAY T_UNDEFINED T_STRING YES NO T_BOOLEAN isArray typeOf $A generateGuid guidFor mixin setupDisplayNames beget extend K */

"export T_ERROR T_OBJECT T_NULL T_CLASS T_HASH T_FUNCTION T_UNDEFINED T_NUMBER T_BOOL T_ARRAY T_STRING T_BOOLEAN YES NO";
"export isArray typeOf $A generateGuid guidFor mixin setupDisplayNames beget extend K";
