...
/*global NodeList SproutCore SC core logger */

"import tiki:core as core";
"import tiki:system/logger as logger";
"export global SC SproutCore YES NO";
"require license";
...
/**
  Default console logger.  You can replace this logger to log output to any
  target you wish.
*/
SC.logger = logger.console;
...
SC.mixin(/** @scope SC */ {
  ...
  // GLOBAL CONSTANTS
  // 
  T_ERROR:     core.T_ERROR,
  T_OBJECT:    core.T_OBJECT,
  T_NULL:      core.T_NULL,
  T_CLASS:     core.T_CLASS,
  T_HASH:      core.T_HASH,
  T_FUNCTION:  core.T_FUNCTION,
  T_UNDEFINED: core.T_UNDEFINED,
  T_NUMBER:    core.T_NUMBER,
  T_BOOL:      core.T_BOOL,
  T_ARRAY:     core.T_ARRAY,
  T_STRING:    core.T_STRING,
  ...
  */
  generateGuid: core.generateGuid,
  ...
  */
  ...
  /**
   ...
   The order is calculated based on SC.ORDER_DEFINITION , if types are 
   different. In case they have the same type an appropriate comparison for 
   this type is made.
